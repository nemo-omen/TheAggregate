...
namespace TheAggregate.Api.Migrations
{
    ...
    [Migration("20250105053915_AddNavigationPropsToSubscription")]
    partial class AddNavigationPropsToSubscription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TheAggregate.Api.Models.Subscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TheAggregate.Api.Models.ApplicationUser", null)
                        .WithMany()
